dataset_type = 'ThreeClassDataset'
...
train_pipeline = [
            ...
            dict(
                ...
                transforms=[
                    ...
                    dict(
                        ...
                        alpha_coef=0.08,
                        p=1),
                    dict(type='MotionBlur', blur_limit=7, p=1),
    ...
    dict(type='RandomRotate', prob=0.5, degree=5.0, pad_val=0, seg_pad_val=0),
